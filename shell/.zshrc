...
# ┌─────────────────────────────────────────────────────────────────────────┐
# │ 🔐 Secrets Loading (Must be very early for security tokens)            │
# └─────────────────────────────────────────────────────────────────────────┘
[[ -f ~/.zsh.secrets ]] && source ~/.zsh.secrets

# ┌─────────────────────────────────────────────────────────────────────────┐
# │ 🎉 Terminal Welcome Screen (Must be before instant prompt)             │
# └─────────────────────────────────────────────────────────────────────────┘
# Display welcome screen for interactive terminals
# This must happen BEFORE P10k instant prompt initialization
if [[ $- == *i* ]] && [[ -z "$WELCOME_SHOWN" ]]; then
    export WELCOME_SHOWN=1
    export WELCOME_SHOW_TIPS=true
    source ~/.dotfiles/terminal-welcome/welcome.sh
fi

# ┌─────────────────────────────────────────────────────────────────────────┐
# │ ⚡ Powerlevel10k Instant Prompt (After all console output)             │
# └─────────────────────────────────────────────────────────────────────────┘
